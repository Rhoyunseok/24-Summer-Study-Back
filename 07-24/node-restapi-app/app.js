...
app.use(function(req,res,next){
  //여기에 모든 사용자의 요청이 있을때마다 실행되어야하는 기능을 구현합니다.
  console.log('전역 어플리케이션 미들웨어 함수가 호출되었습니다.',Date.now());
  //원래 사용자가 요청했던 또는 응답해야하는 프로세스로 흘러가게한다.
  next();
});
...
//만약에 사용자 http://localhost:3000/user/eddy로 접속하면
...
app.use('/user/:id',function(req,res,next){
  ...
  res.send("당신은 시스템에 접근할 수 없는 사용자입니다..블랙리스트입니다.");  
  }
